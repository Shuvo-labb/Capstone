...
<body>
  ...
  <main class="auth-shell">
    <!-- Define card section representing the registration UI -->
    <section class="auth-card">
      ...
      <form id="registerForm" class="auth-form" autocomplete="on" novalidate>
        <!-- Declare input field label wrapper for username -->
        <label class="field">
        ...
        <!-- Declare input field label wrapper for email -->
        <label class="field">
          <!-- Render text span for field label -->
          <span>Email address</span>
          <!-- Render email input field with auto-completion and placeholder text -->
          <input type="email" name="email" id="email" required placeholder="you@example.com" autocomplete="email">
        <!-- Close label wrapper -->
        </label>
        <!-- Declare input field label wrapper for password -->
        <label class="field">
          <!-- Render text span for field label -->
          <span>Password</span>
        ...
        <!-- Declare input field label wrapper for confirming password -->
        <label class="field">
          <!-- Render text span for field label -->
  ...
  <!-- Load deferring register handler script file -->
